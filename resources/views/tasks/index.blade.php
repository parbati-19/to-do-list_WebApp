          ...
          <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
              <div class="p-6 text-gray-900 dark:text-gray-100">
                  ...
                  <form method="GET" action="{{ route('tasks.index') }}" class="mb-6 flex gap-2 flex-wrap">
                      <select name="status" class="min-w-[160px] px-4 py-2 border border-gray-300 dark:border-gray-600 rounded bg-white text-black dark:bg-gray-700 dark:text-white">
                      ...
                      <!-- Sort Options -->
                      <select name="sort_by" class="min-w-[160px] px-4 py-2 border dark:border-gray-600 rounded bg-white text-black dark:bg-gray-700 dark:text-white">
                      ...
                      <select name="direction" class="min-w-[160px] px-4 py-2 border dark:border-gray-600 rounded bg-white text-black dark:bg-gray-700 dark:text-white">
